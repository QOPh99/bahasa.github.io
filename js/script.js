...
const praise = [
  "Goed gedaan!", "Heel goed!", "Top!", "Super!",
  "Mantap!", "Keren!", "Jij kunt dit!"
];
...
function startGame(subKey, pairs) {
  gameArea.innerHTML = "";
  ...
  function showNext() {
    ...
    if (index >= list.length) {
      ...
      `;
      gameArea.querySelector("button").onclick = () => openSubMenu(currentCategory);
      return;
    }
