...
const praise = [
  "Świetna gra! Naprawdę super to rozegrałeś!",
  "Brawo! Mega dobry występ, kontynuuj w tym samym stylu!",
  "Ależ to było dobre! Trzymam kciuki, dawaj dalej!",
  "No nieźle, nieźle! 😎 Grasz coraz lepiej, nie odpuszczaj!",
  "Gratulacje, rozjechałeś to! Trzymaj poziom, jesteś w gazie!",
  "Ale kozak jesteś dzisiaj! Tak trzymać, następny level czeka!",
  "Naprawdę dobrze grasz! Nie zwalniaj tempa, jesteś na fali!"
];
